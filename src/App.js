    ...
    <div className="home-container">
          ...
          <div className="home-navbar">
            <div className="home-left-side">
              ...
              <div className="home-links-container">
                <span className="home-link button anchor">Resources</span>
                <a href="#inspiration" className="home-link01 button anchor">
                  Inspiration
                </a>
                <a href="#process" className="home-link02 button anchor">
                  Process
                </a>
                <a href="#ourstory" className="home-link03 button anchor">
                  Our story
                </a>
              </div>
            </div>
      ...
      <div className="home-container6">
        <div id="inspiration" className="home-features">
          <div className="home-heading-container">
            <h2 className="home-text02 section-Heading">Attributes</h2>
          </div>
      ...
      <div id="ourstory" className="home-our-story">
        <div className="home-heading-container3">
          <h1 className="home-text19 section-Heading">Supporting the Wursts</h1>
